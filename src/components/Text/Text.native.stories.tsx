    ...
    return (
      <div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
        {variants.map(variant => (
          <div key={variant}>
            <Text variant="small" muted style={{marginBottom: 4}}>
              {variant}
            </Text>
            <Text variant={variant}>
              ...
              {variant === 'lead' &&
                'A lead paragraph stands out from the rest.'}
...
export const SemanticElements: Story = {
  render: () => (
    <div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
      <Text variant="h1">This is an h1 element</Text>
      <Text variant="p">This is a p element with paragraph styling.</Text>
      <Text variant="small">This is a span element with small styling.</Text>
...
export const TypographyExample: Story = {
  render: () => (
    <div style={{maxWidth: 600}}>
      ...
      <Text style={{marginBottom: 16}}>
        &quot;I will tax the jokes,&quot; the king declared. &quot;After all,
        everyone loves a good joke, so they will happily pay for the privilege
        of telling one.&quot;
      </Text>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'A complete typography example showing various text styles in context',
      },
    },
  },
};
