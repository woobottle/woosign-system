 ...
 */
export const Switch = forwardRef<View, SwitchNativeProps>(function Switch(
  {
    checked = false,
    onCheckedChange,
    size = 'default',
  ...
  return (
    <Pressable
      ...
      {...pressableProps}>
      <Animated.View style={[trackStyles, {backgroundColor: trackColor}]}>
        <Animated.View
          style={[thumbStyles, styles.thumb, {transform: [{translateX}]}]}
        />
      </Animated.View>
